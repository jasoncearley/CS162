...
public:
    ...
    void setUserGivenName(string); // function used to allow player to name creature
    string getUserGivenName();  // function used to get the user given name of a creature to display
