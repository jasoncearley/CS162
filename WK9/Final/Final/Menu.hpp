...
void stats();
int weapon_selection(); // Function to get, validate, and return user's selection b/w 1-4
int weapon_selection2(); // Function to get, validate, and return user's selection b/w 1-3
#endif
